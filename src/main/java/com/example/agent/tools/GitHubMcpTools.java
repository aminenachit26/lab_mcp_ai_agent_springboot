...
public class GitHubMcpTools implements AgentTool {
    ...
    public String createIssue(
        ...
        // LangChain4j @Tool methods are invoked synchronously by the agent framework,
        // so blocking on the reactive call is required here.
        @SuppressWarnings("unchecked")
        Map<String, Object> result = (Map<String, Object>) mcp.callTool("create_issue", Map.of(
                "owner", owner,
                "repo", repo,
                "title", title,
                "body", body
